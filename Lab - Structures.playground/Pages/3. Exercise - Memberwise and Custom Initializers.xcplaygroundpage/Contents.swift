...
var favouriteBook = Book(title: "Mathematical Equations", author: "R.D. Sharma", pages: 596, price: 899)
print(favouriteBook)
/*:
...
var laptopOne = Laptop(yearPurchased: 2013)
var laptopThree = Laptop(screenSize: 20, repairCount: 2, yearPurchased: 2013)
print(laptopOne, laptopThree)
/*:
