...
firstRun.distance = 2396; firstRun.elevation = 94; firstRun.time = 15.3
print("I have to cover \(firstRun.distance) meters with an elevation of \(firstRun.elevation) meters in \(firstRun.time) minutes.")
/*:
